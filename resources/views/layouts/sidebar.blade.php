        ...
        @if(Auth::user()->role === 'admin')
            ...
            <div class="sidebar-dropdown {{ request()->routeIs('admin.laporan.*') ? 'open' : '' }}">
                ...
                <div class="sidebar-submenu">
                    <a
                        href="#"
                        class="sidebar-link {{ request()->routeIs('admin.laporan.buku.*') ? 'active' : '' }}"
                    >
                        <i class="bi bi-book"></i>
                        <span>Buku</span>
                    </a>
                    ...
                    <a
                        href="#"
                        class="sidebar-link {{ request()->routeIs('admin.laporan.member.*') ? 'active' : '' }}"
                    >
                    ...
                    <a
                        href="#"
                        class="sidebar-link {{ request()->routeIs('admin.laporan.peminjaman.*') ? 'active' : '' }}"
                    >
                    ...
                    <a
                        href="#"
                        class="sidebar-link {{ request()->routeIs('admin.laporan.pengembalian.*') ? 'active' : '' }}"
                    >
