...
<div class="kategori-form-page">
    <div class="kategori-form-card">
        <div class="kategori-form-header">
            ...
            <p>Silakan tambahkan data kategori</p>
        </div>

        <form action="{{ route('admin.kategori.store') }}" method="POST" class="kategori-form">
            @csrf
            <div class="kategori-form-field">
                ...
                <div class="kategori-form-input-wrapper">
                    <input  type="text" id="nama_kategori" name="nama_kategori"  value="{{ old('nama_kategori') }}" placeholder="Masukan nama kategori" class="{{ $errors->has('nama_kategori') ? 'input-error' : '' }}" autocomplete="off">
