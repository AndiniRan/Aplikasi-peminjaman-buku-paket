...
<div class="laporan-page">
    <div class="laporan-card">
        ...
        <form action="{{ route('admin.laporan.peminjaman') }}" method="GET" class="laporan-filter-form">
            ...
            <div class="laporan-filter-actions">
                ...
                <a href="{{ route('admin.laporan.peminjaman') }}" class="laporan-btn-refresh">
                ...
                <div class="laporan-export">
                    ...
                    <div class="laporan-export-menu">
                        <a href="{{ route('admin.laporan.peminjaman.export.excel', request()->query()) }}" data-export-link>
                            <i class="bi bi-file-earmark-excel"></i>
                            Excel
                        </a>

                        <a href="{{ route('admin.laporan.peminjaman.export.pdf', request()->query()) }}" data-export-link>
        ...
        <div class="laporan-control-row">
            ...
            <div class="laporan-search">
                ...
                <input type="text" class="laporan-search-input" placeholder="Cari peminjaman..." value="{{ request('search') }}" autocomplete="off">
            </div>
        </div>
