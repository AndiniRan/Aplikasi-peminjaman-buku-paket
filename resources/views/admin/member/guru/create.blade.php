...
<div class="member-form-page" data-member-type="guru">
    <div class="member-form-card">
        ...
        <div class="member-form-header">
            <h2>Tambah Guru</h2>
            <p>Silakan isi data guru pada form di bawah ini</p>
        </div>

        <form action="{{ route('admin.member.guru.store') }}" method="POST" enctype="multipart/form-data" class="member-form">
            @csrf
            ...
            <div class="member-form-row password-row">
