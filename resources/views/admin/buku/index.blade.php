...
<div class="buku-page">
    <div class="buku-card">
        ...
        <div class="buku-main-actions">
            <a href="{{ route('admin.buku.create') }}" class="buku-btn buku-btn-add">
                <i class="bi bi-plus-lg"></i>
                <span>Tambah Buku</span>
            </a>

            <form action="{{ route('admin.buku.import') }}" method="POST" enctype="multipart/form-data" id="importForm" class="buku-import-form">
                @csrf
            ...
            <a href="{{ route('admin.buku.katalog') }}" class="buku-btn buku-btn-catalog">
                    ...
                    @forelse($buku as $item)
                        <tr class="buku-row"
                            ...
                            <td class="buku-cover-cell">
                                @if($item->sampul)
                                    <img src="{{ asset('storage/' . $item->sampul) }}" alt="{{ $item->judul }}" class="buku-cover-image">
                                @else
                            ...
                            <td>
                                <div class="buku-actions">
                                    <a href="{{ route('admin.buku.show', $item) }}" class="buku-action-btn view" title="Detail">
                                        <i class="bi bi-eye-fill"></i>
                                    </a>

                                    <a href="{{ route('admin.buku.edit', $item) }}" class="buku-action-btn edit" title="Edit">
                                        <i class="bi bi-pencil-square"></i>
                                    </a>

                                    <button type="button" class="buku-action-btn delete buku-delete" data-form="deleteBuku{{ $item->id }}" title="Hapus">
                                        <i class="bi bi-trash-fill"></i>
                                    </button>
                                </div>

                                <form action="{{ route('admin.buku.destroy', $item) }}" method="POST" id="deleteBuku{{ $item->id }}" class="buku-delete-form">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
