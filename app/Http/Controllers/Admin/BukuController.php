...
class BukuController extends Controller
{
    ...
    public function update(Request $request, Buku $buku)
    {
        ...
        $sedangDipinjam = $buku->total_stok - $buku->stok_tersedia;

        if ($validated['total_stok'] < $sedangDipinjam) {
            return back()->withInput()->withErrors([
                'total_stok' => 'Total stok tidak boleh lebih kecil dari jumlah buku yang sedang dipinjam.'
            ]);
        }

        $validated['stok_tersedia'] = $validated['total_stok'] - $sedangDipinjam;
    ...
    public function katalog()
    {
        ...
        return view('admin.buku.katalog', compact('buku', 'kategori'));
    }
}